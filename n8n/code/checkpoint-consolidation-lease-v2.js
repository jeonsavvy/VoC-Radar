...
if (resultItems.length !== 1) {
  resultItems = [{ json: {
    text: '',
    modelCardinalityError: 'consolidation model result count mismatch: expected 1, received ' + resultItems.length,
  } }];
}
...
return [{ json: {
  ...
  phase: 'consolidation',
  resultItems,
  heartbeatPayload: { jobId, claimToken, runId, stage: 'clustering' },
} }];
