...
const PRIVACY_SECTIONS = [
  {
    ...
    body: [
      '로그인 및 수집 실행 권한 확인을 위해 이메일 주소, 인증 식별자, 로그인 세션 정보를 처리합니다.',
      '수집 실행 이력 관리를 위해 App Store ID, 국가 코드, 요청 시각, 실행 상태, 오류 메시지, 요청 계정 식별자를 처리합니다.',
  ...
  },
  {
    title: '2. 개인정보의 처리 목적',
    body: [
      '회원 인증, 수집 실행 권한 확인, 사용자별 작업 이력 조회 및 취소 기능 제공에 사용합니다.',
      'App Store 리뷰 수집, 중복 제거, 우선순위·유형·요약 분석, 공개 대시보드 제공에 사용합니다.',
  ...
  },
  {
    ...
    body: [
      ...
      '수집 실행 이력과 분석 데이터는 서비스 운영 및 분석 이력 보존에 필요한 기간 동안 보관하며, 목적 달성 또는 삭제 요청 시 지체 없이 파기합니다.',
