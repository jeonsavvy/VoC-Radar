...
export function PageHeader({ title, description, status, meta, actions, className }: PageHeaderProps) {
  return (
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl space-y-4">
          ...
          <div className="space-y-3">
            {title ? (
              <h1 className="max-w-3xl text-3xl font-semibold tracking-[-0.04em] text-foreground sm:text-4xl">{title}</h1>
            ) : null}
